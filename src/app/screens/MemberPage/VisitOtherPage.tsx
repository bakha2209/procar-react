...
import { retrieveChosenMember, retrieveChosenSingleBoArticle, retrieveChosenMemberBoArticles } from './selector'
...
const chosenMemberBoArticlesRetriever = createSelector(retrieveChosenMemberBoArticles, chosenMemberBoArticles => ({
...
export function VisitOtherPage(props: any) {
  ...
  console.log("folllowed",chosenMember?.me_followed)
          ...
          <TabContext value={value}>
            <Stack className="my_page_left">
                  ...
                  <Tab
                    ...
                    component={() => (
                      <div className={`menu_box`} onClick={() => setValue('2')}>
                        <GiShadowFollower color="red" style={{ marginRight: '15px' }} />
                        <p>Followers</p>
                      </div>
                    )}
                  />
              ...
              <Box className="phone_box">
                ...
                <Box flexDirection={'column'} marginLeft={'25px'} alignItems={'center'} justifyContent={'center'}>
              ...
              <Box className="social_box">
                <Box flexDirection={'row'} marginBottom={'15px'} alignItems={'center'}>
                ...
                <Box flexDirection={'row'} marginBottom={'15px'} alignItems={'center'} justifyContent={'center'}>
